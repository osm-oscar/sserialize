...
#define SSA_MY_STR_LINE SSA_MY_STR(__LINE__)
	...
	#define SSERIALIZE_CHEAP_ASSERT_ASSIGN(__LEFTHAND, __RIGHTHAND) __LEFTHAND = __RIGHTHAND;
...
#else
	#define SSERIALIZE_CHEAP_ASSERT_ASSIGN(__LEFTHAND, __RIGHTHAND)
...
//normal asserts
	...
	#define SSERIALIZE_NORMAL_ASSERT_ASSIGN(__LEFTHAND, __RIGHTHAND) __LEFTHAND = __RIGHTHAND;
...
#else
	#define SSERIALIZE_NORMAL_ASSERT_ASSIGN(__LEFTHAND, __RIGHTHAND)
...
//expensive asserts
	...
	#define SSERIALIZE_EXPENSIVE_ASSERT_ASSIGN(__LEFTHAND, __RIGHTHAND) __LEFTHAND = __RIGHTHAND;
...
#else
	#define SSERIALIZE_EXPENSIVE_ASSERT_ASSIGN(__LEFTHAND, __RIGHTHAND)
