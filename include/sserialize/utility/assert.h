...
#if defined(WITH_SSERIALIZE_VERY_EXPENSIVE_ASSERT)
	#ifndef WITH_SSERIALIZE_EXPENSIVE_ASSERT
		#define WITH_SSERIALIZE_EXPENSIVE_ASSERT
	#endif
#endif
...
#define SSA_MY_STR_LINE SSA_MY_STR(__LINE__)
	...
	#define SSERIALIZE_CHEAP_ASSERT_PASS(__WHAT) __WHAT
	#define SSERIALIZE_CHEAP_ASSERT_EXEC(__WHAT) __WHAT;
	#define SSERIALIZE_CHEAP_ASSERT_STORE_RESULT(__LEFTHAND, __RIGHTHAND) __LEFTHAND = __RIGHTHAND;
...
#else
	#define SSERIALIZE_CHEAP_ASSERT_EXEC(__WHAT)
	#define SSERIALIZE_CHEAP_ASSERT_PASS(__WHAT)
	#define SSERIALIZE_CHEAP_ASSERT_STORE_RESULT(__LEFTHAND, __RIGHTHAND) __RIGHTHAND;
...
//normal asserts
	...
	#define SSERIALIZE_NORMAL_ASSERT_PASS(__WHAT) __WHAT
	#define SSERIALIZE_NORMAL_ASSERT_EXEC(__WHAT) __WHAT;
...
#else
	#define SSERIALIZE_NORMAL_ASSERT_PASS(__WHAT)
	#define SSERIALIZE_NORMAL_ASSERT_EXEC(__WHAT)
...
//expensive asserts
	...
	#define SSERIALIZE_EXPENSIVE_ASSERT_PASS(__WHAT) __WHAT
	#define SSERIALIZE_EXPENSIVE_ASSERT_EXEC(__WHAT) __WHAT;
...
#else
	#define SSERIALIZE_EXPENSIVE_ASSERT_PASS(__WHAT)
	#define SSERIALIZE_EXPENSIVE_ASSERT_EXEC(__WHAT)
...
//very expensive asserts
#ifdef WITH_SSERIALIZE_VERY_EXPENSIVE_ASSERT
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_ENABLED
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_PASS(__WHAT) __WHAT
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_WHAT(__WHAT) __WHAT;
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT(__BOOL) SSERIALIZE_ASSERT(__BOOL)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_MESSAGE(__BOOL, __MSG) SSERIALIZE_ASSERT_MESSAGE(__BOOL, __MSG)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_EQUAL(__V1, __V2) SSERIALIZE_ASSERT_EQUAL(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_NOT_EQUAL(__V1, __V2) SSERIALIZE_ASSERT_NOT_EQUAL(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_LARGER(__V1, __V2) SSERIALIZE_ASSERT_LARGER(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_LARGER_OR_EQUAL(__V1, __V2) SSERIALIZE_ASSERT_LARGER_OR_EQUAL(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_SMALLER(__V1, __V2) SSERIALIZE_ASSERT_SMALLER(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_SMALLER_OR_EQUAL(__V1, __V2) SSERIALIZE_ASSERT_SMALLER_OR_EQUAL(__V1, __V2)
#else
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_PASS(__WHAT)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_EXEC(__WHAT)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT(__BOOL)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_MESSAGE(__BOOL, __MSG)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_EQUAL(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_NOT_EQUAL(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_LARGER(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_LARGER_OR_EQUAL(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_SMALLER(__V1, __V2)
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_SMALLER_OR_EQUAL(__V1, __V2)
#endif
