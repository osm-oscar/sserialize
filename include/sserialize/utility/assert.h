...
//very expensive asserts
	...
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_ASSIGN(__LEFTHAND, __RIGHTHAND) __LEFTHAND = __RIGHTHAND;
...
#else
	#define SSERIALIZE_VERY_EXPENSIVE_ASSERT_ASSIGN(__LEFTHAND, __RIGHTHAND)
